...
?>
    ...
    <div class="row" xmlns:fb="http://www.w3.org/1999/xhtml">
        ...
        <div class="col-sm-4">
            <p class="btn-group">
                <button type="button" data-toggle="tooltip" class="btn btn-default" title="Add to Wish List" href="<?= Url::to(['/cabinet/default/wishlist-add', 'id' => $product->id]) ?>" data-method="post"><i class="fa fa-heart"></i></button>>
