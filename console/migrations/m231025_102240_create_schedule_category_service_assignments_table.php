...
class m231025_102240_create_schedule_category_service_assignments_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addPrimaryKey('{{%pk-schedule_category_service_assignments}}',
                             '{{%schedule_category_service_assignments}}',
                             [ 'service_id', 'category_id']);

        $this->createIndex('{{%idx-schedule_category_service_assignments-service_id}}',
                           '{{%schedule_category_service_assignments}}', 'service_id');
        $this->createIndex('{{%idx-schedule_category_service_assignments-category_id}}',
                           '{{%schedule_category_service_assignments}}', 'category_id');

        $this->addForeignKey('{{%fk-schedule_category_service_assignments-service_id}}',
                             '{{%schedule_category_service_assignments}}', 'service_id',
