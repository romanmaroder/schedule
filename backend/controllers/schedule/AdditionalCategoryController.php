...
class AdditionalCategoryController extends Controller
{
    public function __construct($id, $module,
       private readonly AdditionalCategoryManageService $service,
        $config = [])
    {
    ...
    {
        $searchModel = new AdditionalCategorySearch();
    ...
    /**
     * @param int $id
     * @return \core\entities\Schedule\Additional\Category the loaded model
