                ...
                <div class="col">
                    <table class='table table-bordered table-striped' id='card'>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= $cart->getFullProfitOnlyFromServicesPaidFor(PaymentOptionsEnum::STATUS_CARD) ?></td>
                            <td class="text-center"><?= $cardExpenses ?? '0' ?></td>
                            <td class="text-right"
                                data-total="<?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CARD,
                                    $cardExpenses
                                ); ?>"><?= $cart->getFullProfitOnlyFromServicesPaidFor(PaymentOptionsEnum::STATUS_CARD) ?>
                                - <?= $cardExpenses ?? '0' ?> </td>
                        </tr>
                        </tbody>
                        <tfoot>
                        <tr>
                            ...
                            <td class="text-right bg-info" data-total="<?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CARD,
                                $cardExpenses
                            ); ?>"><?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CARD,$cardExpenses); ?></td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
                ...
                <div class="col">
                    <table class='table table-bordered table-striped' id='cash'>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= $cart->getFullProfitOnlyFromServicesPaidFor(PaymentOptionsEnum::STATUS_CASH) ?></td>
                            <td class="text-center"><?= $cashExpenses ?? '0' ?></td>
                            <td class="text-right"
                                data-total="<?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CASH,
                                    $cashExpenses
                                ); ?>"><?= $cart->getFullProfitOnlyFromServicesPaidFor(PaymentOptionsEnum::STATUS_CASH) ?>
                                - <?= $cashExpenses ?? '0' ?> </td>
                        </tr>
                        </tbody>
                        <tfoot>
                        <tr>
                            ...
                            <td></td>
                            <td class="text-center"><?= Yii::t('cabinet/report', 'TOTAL') ?>:</td>
                            <td class="text-right bg-success" data-total="<?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CASH,
                                $cashExpenses
                            ); ?>"><?= $cart->getTotalWithSubtractions(PaymentOptionsEnum::STATUS_CASH,$cashExpenses); ?></td>
                        </tr>
                        </tfoot>
                    </table>
                </div>
