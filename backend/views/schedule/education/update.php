...
/* @var $model \schedule\forms\manage\Schedule\Event\EducationEditForm */
/* @var $education \schedule\entities\Schedule\Event\Education */
...
//                'startDate'      => date('Y-m-d'),
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group"><?= $form->field($model, 'title')->textInput(
                            ['maxlength' => true]
                        ); ?></div>
                </div>
            </div>
