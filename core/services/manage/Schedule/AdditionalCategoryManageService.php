...
class AdditionalCategoryManageService
{
    private $categories;
    private $services;

    public function __construct(AdditionalCategoryRepository $categories,
        AdditionalRepository $services)
    {
     ...
     * @return \core\entities\Schedule\Additional\Category
     */
