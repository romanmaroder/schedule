    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class=""><a href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">0 reviews</a> / <a
    ...
    <div class="row" xmlns:fb="http://www.w3.org/1999/xhtml">
        ...
        <div class="col-sm-4">
            ...
            <ul class="list-unstyled">
                <li>Brand: <a href="<?= Html::encode(
                        Url::to(['brand', 'id' => $product->brand->id])
                    ) ?>"><?= Html::encode($product->brand->name) ?></a></li>
                <li>
                    Tags:
                    <?php
                    foreach ($product->tags as $tag): ?>
            ...
            <div id="product">
                ...
                $form = ActiveForm::begin(
                    ...
                    <div class="form-group">
                        <?= Html::submitButton(
                            'Add to Cart',
                            ['class' => 'btn btn-sm btn-primary btn-block btn-shadow']
                        ) ?>
                    </div>
            ...
            <div class="rating">
                ...
                <div class="addthis_toolbox addthis_default_style" data-url="/index.php?route=product/product&amp;product_id=47"><a class="addthis_button_facebook_like" fb:like:layout="button_count"></a>
